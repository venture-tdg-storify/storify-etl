create or replace procedure arteli_db_ingestion.tdg_ingestion.load_raw_old_transactions()
returns varchar(16777216)
language javascript
strict
execute as owner
as '
    var sql_command = `insert into arteli_db_ingestion.tdg_ingestion.raw_old_transactions (
        _file,
        _line,
        _modified,
        location_id,
    ...
    new_files as (
        ...
        loaded_files as(
            ...
            from arteli_db_ingestion.tdg_ingestion.raw_old_transactions
        )
        ...
        from @tdg_stage/old_transactions/ (file_format => s3_csv_old_transactions) t
