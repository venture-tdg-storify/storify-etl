create or replace procedure arteli_db_ingestion.dsg_ingestion.load_single_raw_inventory()
...
select
    ...
    t.$20 as qty_on_hand,
    t.$21 as trans_date
from @dsg_stage/inventory/Inventory_20240420.csv (file_format => s3_csv_inventory) t
`;
